         ...
         <div className="w-1/6  ">
             ...
             <nav className={`${!menu ? 'hidden delay-300  h-[500rem]  ':" bg-black rounded-xl "}`}>
                 <ul className=" animate__animated animate__backInLeft h-[500rem] pt-4">
                     ...
                     <NavLink to={'/UserDasbod'}><li className="text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Adoption Request</li></NavLink>
                     ...
                     <NavLink to={'/UserDasbod'}><li className="text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">My Donation Campaigns</li></NavLink>
